...
return [
    ...
    */
    ...
    'custom' => [
        'alias' => [
            'regex' => 'Поле может содержать только латинские символы, цифры и знак дефиса.',
            'unique' => 'Alias должен быть уникальным. Такой alias уже существует.',
        ],
	    'vendor_code' => [
		    'regex' => 'Поле может содержать только латинские и кириллические буквы, цифры и знак дефиса.',
	    ],
	    'price' => [
	    ...
	    'login' => [
		    ...
		    'regex' => 'Поле может содержать только латинские буквы, цифры, дефис и знак нижнего подчёркивания.',
	    ],
	    'user_name' => [
