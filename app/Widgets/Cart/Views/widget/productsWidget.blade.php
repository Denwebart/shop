                        ...
                        @if($item['product'])
                            ...
                            <div class="shopping-cart__item__info__qty">
                                <div class="input-group-qty pull-left">
                                    ...
                                    <input type="date" name="quantity" class="input-number change-quantity input--wd input-qty pull-left" value="{{ $item['quantity'] }}" data-old-value="{{ $item['quantity'] or 0 }}" min="1" max="1000" data-product-id="{{ $item['product']->id }}" data-product-key="{{ $key }}">
