...
$title = 'Редактирование отзыва о магазине';
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-xs-12 hidden-xs">
            <ul class="breadcrumb m-b-10">
                ...
                <li><a href="{{ route('admin.reviews.index') }}">Отзывы о магазине</a></li>
                <li>{{ $title }}</li>
            </ul>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                {!! Form::model($review, ['route' => ['admin.shop_reviews.update', $review->id], 'class' => 'form-horizontal', 'id' => 'main-form', 'files' => true]) !!}
