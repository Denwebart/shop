    ...
    <div class="property clearfix m-b-20" data-property-id="{{ $property->id }}">
        <div class="col-md-12 col-sm-12 col-xs-12 m-b-10 bg-muted">
            <h4 class="header-title m-t-10 m-b-10 pull-left">
                <a href="#" class="editable-text" data-value="{{ $property->title }}" data-name="title" data-type="text" data-pk="{{ $property->id }}" data-url="{{ route('admin.properties.setPropertyValue') }}"><b>{{ $property->title }}</b></a>
