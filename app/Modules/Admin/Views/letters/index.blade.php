...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="count-container">
                @include('parts.count', ['models' => $letters])
            </div>
        </div>
        <div class="col-sm-8">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="white-bg @if(count($letters)) card-box @endif">
                <div id="table-container" class="table-responsive m-b-20">
                    @include('admin::letters.table')
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="pagination-container pull-right">
                            @include('parts.pagination', ['models' => $letters])
                        </div>
                    </div>
                </div>
            </div>
